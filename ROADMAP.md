...
- [ ] Push notification improvements (FCM integration)
- [ ] Live ETA updates during service

### 💳 Payment Enhancements

- [ ] Multiple payment methods (GCash, PayMaya, Card)
...
- [ ] Provider portfolio and gallery
- [ ] Customer preferences and notes
- [ ] Multi-language support (EN, KO, TL)

### 🛠️ Admin Features

- [ ] Bulk provider approval/rejection
